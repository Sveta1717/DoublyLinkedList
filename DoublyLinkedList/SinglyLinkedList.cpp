// SinglyLinkedList.cpp : Реализовать класс SinglyLinkedList, представляющий собой однонаправленный список для удобной работы с целыми числами типа int.
